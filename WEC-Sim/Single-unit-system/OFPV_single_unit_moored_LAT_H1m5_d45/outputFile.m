...
surgePlotTitle = 'Surge motion, LAT, H = 1.5 m';
swayPlotTitle  = 'Sway motion, LAT, H = 1.5 m';
heavePlotTitle = 'Heave motion, LAT, H = 1.5 m';
rollPlotTitle  = 'Roll motion, LAT, H = 1.5 m';
pitchPlotTitle = 'Pitch motion, LAT, H = 1.5 m';
yawPlotTitle   = 'Yaw motion, LAT, H = 1.5 m';

surgeExcPlotTitle = 'Surge excitation force, LAT, H = 1.5 m';
heaveExcPlotTitle = 'Heave excitation force, LAT, H = 1.5 m';
pitchExcPlotTitle = 'Pitch excitation moment, LAT, H = 1.5 m';
