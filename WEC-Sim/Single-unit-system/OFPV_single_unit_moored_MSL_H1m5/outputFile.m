...
surgePlotTitle = 'Surge motion, MSL, H = 1.5 m';
swayPlotTitle  = 'Sway motion, MSL, H = 1.5 m';
heavePlotTitle = 'Heave motion, MSL, H = 1.5 m';
rollPlotTitle  = 'Roll motion, MSL, H = 1.5 m';
pitchPlotTitle = 'Pitch motion, MSL, H = 1.5 m';
yawPlotTitle   = 'Yaw motion, MSL, H = 1.5 m';

surgeExcPlotTitle = 'Surge excitation force, MSL, H = 1.5 m';
heaveExcPlotTitle = 'Heave excitation force, MSL, H = 1.5 m';
pitchExcPlotTitle = 'Pitch excitation moment, MSL, H = 1.5 m';
