...
surgePlotTitle = 'Surge motion, MSL, H = 6.7 m';
swayPlotTitle  = 'Sway motion, MSL, H = 6.7 m';
heavePlotTitle = 'Heave motion, MSL, H = 6.7 m';
rollPlotTitle  = 'Roll motion, MSL, H = 6.7 m';
pitchPlotTitle = 'Pitch motion, MSL, H = 6.7 m';
yawPlotTitle   = 'Yaw motion, MSL, H = 6.7 m';

surgeExcPlotTitle = 'Surge excitation force, MSL, H = 6.7 m';
heaveExcPlotTitle = 'Heave excitation force, MSL, H = 6.7 m';
pitchExcPlotTitle = 'Pitch excitation moment, MSL, H = 6.7 m';
